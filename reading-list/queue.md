# Landmark Medical AI Papers — Reading Queue

Curated backlog of landmark / field-defining papers in medical AI for the
daily decode. The daily run takes the next unchecked paper, unless a genuinely
major new medical-AI paper published that week deserves priority (in which
...
- [ ] Beam AL, Kohane IS. Big Data and Machine Learning in Health Care. JAMA, 2018. — *deferred 2026-09-15: full text unreachable (no PMC record; publisher and third-party hosts blocked by network policy; full-text service at monthly limit until 2026-10-01), and this is a short commentary/review piece, so abstract-only was judged not worth decoding. Retry with a PDF or after the service resets.*
